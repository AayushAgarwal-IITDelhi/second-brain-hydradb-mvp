...
class TestGetCached:
    ...
    def test_miss_returns_none(self):
        from query_cache import build_cache_key, get_cached
    ...
    def test_cache_disabled_always_misses(self):
        from query_cache import build_cache_key, get_cached, put
    ...
    def test_invalidate_all_clears_cache(self):
        from query_cache import get_cached, invalidate_all, put
